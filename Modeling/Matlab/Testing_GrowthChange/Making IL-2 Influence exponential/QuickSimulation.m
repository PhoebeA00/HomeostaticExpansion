...
%%
ModelData = SimulateGrowth(p0, 2);

csvwrite('~/my.work/PhD/HomestaticExpansionProject/Code/Stats plots and data management/ModelOutputKO.csv', ModelData)
